...
const MessageSender = () => {
    ...
    return (
        <div className="messageSender">
            <div className="messageSender__top">
                ...
                <form action="">
                    ...
                    <input onChange={(e)=>setImageUrl(e.target.value)} value={imageUrl} type="text" placeholder="image URL (Optional)" id="imageUrl" />
        ...
        <PhotoLibraryIcon style={{ color: 'green' }} />
            ...
            <div className="messageSender__option none">
